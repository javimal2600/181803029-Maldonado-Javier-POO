            ...
            <table>
                ...
                <table style="margin: 0 auto;" class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary btn-block" href="editarUsuario.jsp?id_usubtn-primary btn-blockarios=<%= rs.getInt("id_usuarios")%>"> Editar usuario</a>                   
                            <a class="btn btn-warning btn-block " href="editarContraseña.jsp?id_usuarios=<%= rs.getInt("id_usuarios")%>">Editar contraseña</a>
